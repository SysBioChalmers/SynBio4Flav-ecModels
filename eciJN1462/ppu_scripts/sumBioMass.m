...
bioPos = find(strcmp(model.rxnNames,'Biomass_P_putida_KT2440__aa_DNA_RNA_ATP_murein_FA_ions_soluble_'));
...
rxnName = 'Biomass_P_putida_KT2440__aa_DNA_RNA_ATP_murein_FA_ions_soluble_';
%Add up fraction:
