...
% simulations on different carbon sources. Script designed for Salb-GEM
% metabolic network of S. albus metabolism.
%
...
model.ub(strcmp(model.rxnNames,'O2 exchange'))    = 0;
